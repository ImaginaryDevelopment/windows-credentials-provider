...
class Program {
    static void Main() {
        ...
        var runType =
            ...
            CredentialHelper.CommandParser.CommandType.NewOutputDiagnostics(true) :
        ...
        if (runType.IsAttemptLogin) {
            ...
            var pause = CredentialHelper.CommandParser.CommandType.TryGetOutputDiagnostics(runType)?.Value == true;
            CredentialHelper.CompositionRoot.outputDiagnostics(pause, Guid.Parse(Constants.CredentialProviderUID));
        } else {
